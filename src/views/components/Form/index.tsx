              ...
              >
                <FormControl className={styles.formBox}>
                  <FormLabel className={styles.formLabel}>
                    {i18n.get('FORM_NORMAL_INPUTS_LABEL')}
                  </FormLabel>
                  <Field
                        ...
                        filterOptions={(options, params) => {
                          ...
                          if (params.inputValue !== '') {
                            filtered.push({
                              ...
                              word: `${i18n.get('FORM_INCLUDED_WORDS_INPUT_PLACEHOLDER')} "${
                                params.inputValue
                              }"`,
                            });
                          }
